...
module namespace nxxpath = "http://eNahar.org/ns/lib/ical/xxpath";
...
declare function nxxpath:mergeRuns(
...
declare function nxxpath:highest(
                     $f as function(item()) as xs:anyAtomicType, 
                     $seq as item()*)
                  as item()*
{
...
declare function nxxpath:lowest(
                     $f as function(item()) as xs:anyAtomicType, 
                     $seq as item()*)
                  as item()*
{
...
To find the employees with the highest salary, the function might be called as:
    ...
    nxxpath:highest(function($emp){$emp/salary}, //employee)
:)

declare function nxxpath:sort(
                     $f as function(item()) as xs:anyAtomicType, 
                     $seq as item()*)
                  as item()*
{

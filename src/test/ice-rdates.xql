xquery version "3.0";
module namespace ice-rdates="http://enahar.org/enahar/test/ice-rdates";
...
declare %test:setUp function ice-rdates:setup()
{
    ()
};

declare %test:tearDown function ice-rdates:cleanup()
{
    ()
};
(: ----------------------------
...
(:
 ...
 :
 :)
declare %test:assertXPath("count($result)=2") function ice-rdates:match()
{
    ...
    (
        <event xmlns="http://hl7.org/fhir">
            <rdate value="2014-05-27"/>
            <rdate value="2014-05-28"/>
        </event>
    , 
        <event xmlns="http://hl7.org/fhir">
            <rdate>
